...
1. Нажмите единственную кнопку `📞 Получить номер` под квартирой.
2. В личном сообщении нажмите `💳 Оплатить через Finik`. После перехода эта кнопка
   исчезнет и останется только `✅ Я оплатил`.
3. После оплаты нажмите `✅ Я оплатил`; кнопка исчезнет, а администратор получит push.
