...
2. После оплаты нажмите `✅ Я оплатил / Получить номер` в той же карточке.
3. Администратор получает push-карточку с `Подтвердить/Отказать`.
4. После подтверждения нажмите `✅ Я оплатил / Получить номер` ещё раз.
5. Номер появится только в персональном callback alert нажавшего пользователя —
   не в группе и не в личном сообщении бота.
