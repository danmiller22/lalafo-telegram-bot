...
- `LALAFO_AUTO_REPLY_POLL_SECONDS=60`. Значение меньше минуты принудительно
  повышается до 60 секунд; ответы не содержат внешних ссылок, ограничены тремя
  за один проход и двадцатью за сутки, а одному диалогу бот отвечает не чаще
  одного раза в 24 часа. Авторизованный вход никогда не переключается на
  случайные публичные прокси.
