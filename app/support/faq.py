...
FAQ_ITEMS = (
    FAQItem(
        ...
        answer=(
            ...
            "оплачен, номер появится в этом же окне."
        ),
    ),
    FAQItem(
        key="week",
    ...
    FAQItem(
        ...
        answer=(
            ...
            "ссылке. Чек отправлять не нужно."
        ),
    ),
    FAQItem(
        key="review",
        ...
        answer=(
            "❓ Вернитесь к квартире и нажмите «Посмотреть номер», затем «Обновить "
            "статус». Повторно не платите. Если доступ не появился через несколько "
            "минут, напишите сюда сумму и время оплаты."
        ),
    ),
    FAQItem(
        key="wanted",
