...
TERMS_VERSION = "2026-09-24-v2"
TERMS_ACCEPT_BUTTON = "✅ Я ознакомлен(а) с условиями и согласен(на) со всеми пунктами"
TERMS_TEXT = (
    "Объявления собираются из открытых источников. Мы не можем проверить личность "
    ...
    "При заселении сверьте личность человека, его право собственности "
