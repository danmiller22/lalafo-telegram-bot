...
DEFAULT_SEARCH_URL = (
    ...
    "mozhno-s-zhivotnymi"
    "?price[from]=23000&price[to]=40000"
)
...
INVENTORY_SEARCH_URLS: tuple[str, ...] = (
    f"{_INVENTORY_BASE}owner?price[from]=23000&price[to]=29999",
    f"{_INVENTORY_BASE}owner?price[from]=30000&price[to]=40000",
    f"{_INVENTORY_BASE}real-estate-agency?price[from]=23000&price[to]=40000",
    ...
    f"{_INVENTORY_BASE}?price[from]=23000&price[to]=29999",
